    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maskImage:
            'radial-gradient(ellipse 70% 60% at 50% 40%, #000 0%, transparent 80%)',
        }}
      />
      ...
      <div className="flex w-full max-w-3xl flex-col items-center text-center lg:max-w-4xl">
        ...
        <span
          ...
          style={{
            borderColor:
              'color-mix(in srgb, var(--d2-reveal) 45%, var(--d2-border))',
            color: 'var(--d2-reveal)',
        ...
        >
          <span
            ...
            style={{ background: 'var(--d2-reveal)' }}
          />
        ...
        {/* Headline */}
        <h1
          className="mt-6 text-balance font-sans text-[clamp(2rem,6vw,4.25rem)] font-bold leading-[1.05] tracking-tight"
          style={{
            color: 'var(--d2-text)',
            animation: 'sc-fade-up 480ms var(--d2-ease-out) 80ms both',
          }}
        >
          See what Stripe really costs you
          <span style={{ color: 'var(--d2-reveal)' }}>&nbsp;&mdash;&nbsp;</span>
          and your exact savings with EPD
        </h1>
        ...
        <p
          ...
          style={{
            color: 'var(--d2-text2)',
            animation: 'sc-fade-up 480ms var(--d2-ease-out) 160ms both',
          }}
        >
          Upload your Stripe statement and we read it line by line. No sliders,
          no guesswork &mdash; just the real numbers, showing what you&rsquo;d
          keep on EPD&rsquo;s{' '}
          <span
        ...
        <p
          ...
          style={{
            color: 'var(--d2-muted)',
            animation: 'sc-fade-up 480ms var(--d2-ease-out) 320ms both',
          }}
        >
