 ...
 *
 * Copy this into the app at `types/contract.ts` (alias `@/types/contract`) and
 * import it from BOTH the route handlers and the frontend client so the contract
 * can't drift. See docs/03-api-contract.md for full semantics.
 */
